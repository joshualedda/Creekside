<?php 
	...
	if (isset($_POST['submit'])) {
		...
		$sql = "UPDATE transactions SET status = 'Cancelled' WHERE trans_id = $trans_id"; 
...
//for transation logs
          ...
          ('$timestamp', $user_id, '$name', 'Cancel Transaction', 'Confirmed cancellation of transaction with $cName')";
...
<?php		
			echo "
				<script = 'text/javascript>
					...
					location.href = 'transactions-cancelled.php';
				</script>
				";
