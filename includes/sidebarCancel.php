...
<?php 
  ...
  if ($role === 'Admin') { ?>
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapse" data-bs-target="#trans-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-cart3"></i>
          <span>Transactions</span> 
          <i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="trans-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
          ...
          <li>
            <a href="transactions-cancelled.php" class="active">
              <i class="bi bi-circle-fill"></i><span>Cancelled</span>
            </a>
          </li>
        </ul>
