...
<head>
  ...
  include 'includes/sidebarCancel.php';
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Transactions (Cancelled)</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="card-body">
          ...
          <table class="table table-hover datatable">
            ...
            <tbody>
              ...
              $query = "SELECT transactions.*, concat(users.fname,' ',users.lname) as attendant FROM `transactions` LEFT JOIN `users` ON transactions.user_id = users.user_id WHERE status = 'Cancelled' ORDER BY date_cancelled DESC";
              ...
              if ($result) {
                while ($row = $result->fetch_assoc()) {
                  ...
                  <tr>
                    ...
                    <td><?php echo date('F j, Y', strtotime($date_cancelled)); ?></td>
                                    ...
                                    if ($resultQuery) {
                                      while ($row = $resultQuery->fetch_assoc()) {
                                        ...
                                        <tr data-dish-id="<?php echo $dish_id ?>">
                                          ...
                                          <td class="col-3"><?php echo $quantity ?></td>
