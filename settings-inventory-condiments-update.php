<?php 
  ...
  if (isset($_POST['submit'])) {
    ...
    $queryBeforeUpdate = "SELECT quantity FROM inventory_condiments WHERE id = $id";
    ...
    if ($resultBeforeUpdate) {
      ...
      // Update the inventory_condiments table
      $sql = "UPDATE inventory_condiments SET item_name = '$item_name', quantity = $quantity, unit = '$unit' WHERE id = $id";
      ...
      if (mysqli_query($con, $sql)) {
        ...
        $description = "$action " . abs($quantityDifference) . " $unit(s) of $item_name $preposition inventory of condiments";
