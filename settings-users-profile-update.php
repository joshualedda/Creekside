...
//for transation logs
          ...
          ('$timestamp', $user_id, '$name', 'Edit Profile', 'Edited a user profile')";
          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <li class="nav-item">
                  <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-delete">Delete Profile</button>
                </li>
...
<!-- Change Password Form -->
                  <form class="needs-validation" novalidate action="settings-account-password-update.php" method="POST">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="username" type="text" class="form-control" id="username" value="<?php echo $_POST['username'] ?>">
                      </div>
                    </div>
...
<!-- Delete Profile Form -->
                  <form class="needs-validation" novalidate action="settings-users-profile-delete.php" method="POST">
                    ...
                    <div class="col-sm-10">
                      <h5>You are about to delete this user's profile. Are you sure you want to proceed?</h5>
                      <h5></h5>
                    </div>
                    <h5></h5>
                    <input name="username" type="text" id="username" hidden value="<?php echo $username ?>">
                    <div class="" style="text-align: right;">
                      <button type="button" class="btn btn-secondary" onclick="location.reload()">Cancel</button>
                      <button type="submit" class="btn btn-danger" name="submit">Delete Profile</button>
                    </div>
...
<?php
			echo "
				<script = 'text/javascript>
					alert('You have successfuly updated this profile!');
