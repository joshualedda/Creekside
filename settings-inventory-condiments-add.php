<?php 
	...
	if (isset($_POST['submit'])) {
		...
		$sql = "INSERT INTO inventory_condiments (item_name,
									   quantity,
									   unit)
						   	  VALUES ('$item_name',
								      '$quantity',
...
//for transation logs
          ...
          ('$timestamp', $user_id, '$name', 'Add Item', 'Added $quantity $unit(s) of $item_name into inventory of condiments')";
...
<?php			echo "
				<script = 'text/javascript>
					alert('You have successfuly added a new item!');
