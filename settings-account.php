                  ...
                  <div class="tab-content pt-2">
                    ...
                    <div class="tab-pane fade show active profile-overview" id="profile-overview">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-9 col-md-8"><?php echo $sex ?></div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-9 col-md-8"><?php echo $contact_no ?></div>
                      </div>
...
<script>
  ...
  showCurrent.addEventListener("click", function current() {
    if (passwordCurrent.type === "password") {
      passwordCurrent.type = "text";
      showCurrent.innerHTML = '<font size="5px" color="#6c757d"><i class="bi bi-eye-slash"></i></font>';
    } else {
      passwordCurrent.type = "password";
      showCurrent.innerHTML = '<font size="5px" color="#6c757d"><i class="bi bi-eye"></i></font>';
    }
  });
