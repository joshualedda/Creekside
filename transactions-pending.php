...
?>
                  <tr>
                    ...
                    <?php } ?> 
                    <td>
                      <button class="btn btn-secondary btn-sm " data-bs-toggle="modal" data-bs-target="#editCustomer-<?php echo $trans_id ?>" <?php echo ($status == 'Paid') ? 'disabled' : '' ?>><i class="bi bi-pencil-square"></i> </button>
                      <?php if ($status == 'Paid') { ?>
                        <button class="btn btn2 btn-sm " data-bs-toggle="modal" data-bs-target="#viewDishes-<?php echo $trans_id ?>"><i class="ri ri-restaurant-fill"></i> </button>
                      <?php } else { ?>
                      ...
                      <?php } ?>
                      <button class="btn btn-primary btn-sm paid-btn" data-bs-toggle="modal" data-bs-target="#paid-<?php echo $trans_id ?>" <?php echo ($total_price == 0.00) ? 'disabled' : '' ?> <?php echo ($status == 'Paid') ? 'hidden' : '' ?>><font style="padding: 2px;">₱</font></button>
                      <button class="btn btn-success btn-sm complete-btn" data-bs-toggle="modal" data-bs-target="#completeOrder-<?php echo $trans_id ?>" <?php echo ($status == 'Pending') ? 'hidden' : '' ?>><i class="bi bi-check-circle"></i></button>
                      <button class="btn btn-danger btn-sm " data-bs-toggle="modal" data-bs-target="#cancelOrder-<?php echo $trans_id ?>" <?php echo ($status == 'Paid') ? 'disabled' : '' ?>><i class="bi bi-x-circle"></i></button> 
                                  ...
                                  <div class="col-auto">
                                    <div class="card">
                                      <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            <label for="searchDish" class="form-label"><h5 class="card-title">Food Menu:</h5></label>
                                        ...
                                        <table class="table table-hover">
                                          ...
                                          <tbody id="dishTableBody">
                                            <tr>
                                              <td colspan="3" align="center"><font color="#6c757d">--Search to display dish details--</font></td>
                                            </tr>
                                          </tbody>
                                        </table>
                                      </div>
