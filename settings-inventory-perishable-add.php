<?php 
	...
	if (isset($_POST['submit'])) {
		...
		$sql = "INSERT INTO inventory_perishable (item_name, quantity)
...
//for transation logs
          ...
          ('$timestamp', $user_id, '$name', 'Add Item', 'Added $quantity kilogram(s) of $item_name into inventory of perishables')";
...
<?php			echo "
				<script = 'text/javascript>
					alert('You have successfuly added a new perishable item!');
